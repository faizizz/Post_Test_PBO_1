...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Lapas lapas = new Lapas("L001", "Lapas Sukamiskin", 500);
    ...
    private static void tambahNarapidana(Scanner scanner) {
        ...
        Narapidana narapidana = new Narapidana(id, nama, masaTahanan);
        narapidanaList.add(narapidana);
    ...
    private static void lihatSemuaNarapidana() {
        if (narapidanaList.isEmpty()) {
            ...
            System.out.println("Total Narapidana: " + Narapidana.getTotalNarapidana());
        }
    }
    ...
    private static void updateNarapidana(Scanner scanner) {
        ...
        for (Narapidana n : narapidanaList) {
            if (n.getId().equals(id)) {
                ...
                System.out.println("Data narapidana berhasil di-update.");
                return;
            }
        }
    ...
    private static void hapusNarapidana(Scanner scanner) {
        ...
        for (Narapidana n : narapidanaList) {
            if (n.getId().equals(id)) {
                ...
                System.out.println("Narapidana berhasil dihapus.");
                return;
            }
        }
        System.out.println("Narapidana dengan ID tersebut tidak ditemukan.");
